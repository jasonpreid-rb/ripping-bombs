        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(180px,1fr))', gap: 36, marginBottom: 40 }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 5, marginBottom: 20 }}>
              {[['Average Drive Distance','/average-golf-drive-distance-by-age'],['Longest Drives This Week','/longest-drives-this-week'],['How Far Do I Drive Compared To Others?','/how-far-do-i-drive-compared-to-others'],['Longest Drive Ever','/longest-golf-drive-ever'],['What Is A Good Drive?','/what-is-a-good-drive-in-golf'],['Long Drive Competition Guide','/golf-longest-drive-competition'],['Long Drive Equipment','/long-drive-golf-equipment'],['Supported Simulators','/supported-simulators']].map(([l,h]) => (
                <Link key={h} href={h} style={{ display: 'block', fontFamily: SANS, fontSize: 11, color: 'rgba(255,255,255,0.4)', textDecoration: 'none' }} onMouseEnter={e=>e.target.style.color=ORG} onMouseLeave={e=>e.target.style.color='rgba(255,255,255,0.4)'}>{l}</Link>
              ))}
            </div>

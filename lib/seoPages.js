...
//
// A redirect for "/golf-long-drive-competition" → "/golf-longest-drive-competition"
// already exists in next.config.js, in case any external links or old
// bookmarks still use the shorter slug.
//
...
const seoPages = [
  ...
  { slug: 'indoor-golf-league-ranking-system', title: 'Indoor Golf League Ranking System', description: 'How to structure a fair ranking system for an indoor golf league, with live standings players actually check.', category: 'simulator', priority: 0.9, changefreq: 'monthly' },
  ...
  { slug: 'enjoy-golf-when-you-cant-break-par', title: "Can't Break Par? Here's a Golf Scoreboard You Can Win", description: 'Score gets harder to move the better you get. See why breaking par is so rare, and get ranked on distance instead — against your age, handicap, country, and the globe.', category: 'guides', priority: 0.9, changefreq: 'monthly' },

  // ───────── Competitions & events ─────────
  { slug: 'golf-longest-drive-competition', title: 'Golf Longest Drive Competition', description: 'How to enter or run a longest drive competition, with live rankings and verified results.', category: 'competitions', priority: 0.9, changefreq: 'monthly' },
